          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex gap-3 mt-4">
              <button
                type="button"
                onClick={onClose}
                className="flex-1 py-3.5 px-4 rounded-xl bg-white/5 text-sm font-medium text-white hover:bg-white/10 active:bg-white/5 transition-colors border border-white/5 font-semibold"
              >
                Cancel
              </button>
              <button
